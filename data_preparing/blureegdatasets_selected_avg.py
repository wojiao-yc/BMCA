...
class EEGDataset():
    def __init__(self, data_path, subjects=None, train=True, avg=True ,time_window=[0, 1.0]):
        ...
        features_filename = "/home/wenxiao/workspace/qhy/BMCA/data/RN50_openai_train_blur51.pt" \
            if self.train else "/home/wenxiao/workspace/qhy/BMCA/data/RN50_openai_test_blur51.pt"

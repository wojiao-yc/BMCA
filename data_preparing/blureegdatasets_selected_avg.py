...
class EEGDataset():
    def __init__(self, data_path, subjects=None, train=True, avg=True ,time_window=[0, 1.0]):
        ...
        features_filename = "/home/wenxiao/workspace/qhy/BMCA/data/RN50_train_blur3.pt" \
            if self.train else "/home/wenxiao/workspace/qhy/BMCA/data/RN50_test_blur3.pt"
        print("Loading features from:", features_filename)
        # features_filename = "/home/wenxiao/workspace/qhy/Uncertainty-aware-Blur-Prior/data/things_eeg/Image_feature/FoveaBlur/RN50_train.pt" \
